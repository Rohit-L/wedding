...
import { couple, mealOptions } from "~/data/wedding";
...
export const meta: Route.MetaFunction = () => [
  { title: `RSVP · ${couple.combined}` },
  {
    name: "description",
    content: `Let ${couple.combined} know whether you can celebrate with them.`,
  },
  // Leaf meta replaces root meta entirely, so re-declare the browser-chrome
  // color to match the rest of the site.
