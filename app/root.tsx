...
export const links: Route.LinksFunction = () => [
  ...
  // The couple's names (hero and password pages) use a self-hosted font
  // (see app.css) since it isn't on Google Fonts.
  {
    rel: "stylesheet",
    href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300..600;1,9..144,300..500&family=Libre+Baskerville:ital,wght@0,400;0,700;1,400&family=Urbanist:ital,wght@0,100..900;1,100..900&display=swap",
  },
